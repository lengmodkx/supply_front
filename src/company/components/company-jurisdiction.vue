<template>
    <div class="project-permission-content">
        ...
        <div class="pcc-operate">
            ...
            <Button type="warning" icon="ios-create-outline" @click="editRole" :disabled="nowRole.isSystemInit">编辑
            </Button>
            <Button type="error" icon="ios-trash-outline" @click="showRomoveRole=true" :disabled="nowRole.isSystemInit">
                删除
            </Button>
        ...
        <Modal v-model="permissionAssign" title="企业权限分配" width="850px" class="padd0" footer-hide>
            <project-permission :flag="true" :permissions="permissions" :role="nowRole" v-if="permissionAssign"
                                ref="permission" @close="permissionAssign = false"></project-permission>
        </Modal>
        <!-- 删除 -->
