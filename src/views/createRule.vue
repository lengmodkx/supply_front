<template>
    <div>
       <div class="rule-head">
           <Icon @click="$emit('cancelRule')" class="fonts" size="20" type="ios-arrow-back" />
           <input type="text" v-model="ruleData.name">
           <span class="fonts" @click="save">保存</span>
       </div>
        <div class="rule-con" style="padding: 20px 0">
    ...
    export default {
        ...
        methods: {
            ...
            clickList(item) {
                ...
                this.hasSelectList=item.relationName
                this.selList=false
                // 清空下面的值
                this.showOptionName=''
