<template>
  <div class="login-form-box">
    ...
    <Form ref="formValidate" @keyup.native.enter="login('formValidate')" :model="formValidate" :rules="ruleValidate"
      class="login-box">
      ...
      <div class="content" v-if="!showQrcode">
        ...
        <FormItem>
          <Button type="primary" long size="large" class="login" @click="login('formValidate')"
      ...
      <div class="weChat" id="wx_qrcode" v-else>
        <wxlogin :appid="'wxb7b91f87460a9d90'" :response_type="'code'" :scope="'snsapi_login'"
          :redirect_uri="'https://work.aldbim.com'" href="data:text/css;base64,LmltcG93ZXJCb3ggLnRpdGxle2Rpc3BsYXk6bm9uZTt9"></wxlogin>
      </div>
