<template>
  <div class="wrap-recorder">
    <div>
      <svg @click="handleClick" :class="['icon', { anirecorder: recording }]" t="1581399509621" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3242" width="50" height="50">
        <path
  ...
  methods: {
    init() {
      this.recorder = new MP3Recorder({
        ...
        //sampleRate: 48000,   //采样率,一般由设备提供,比如 48000
