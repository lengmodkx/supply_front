<template>
   <div class="bind-box">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="rules2" class="bind-box-form" v-if="show">
         ...
         <FormItem>
            <Button type="primary" long size="large" @click="show=!show,showTxt=true"
               :disabled="formValidate.nickName.length<2||formValidate.nickName.length>20">确定</Button>
      ...
      <Form ref="formValidate" :model="formValidate" :rules="rules" class="bind-box-form" v-else>
         ...
         <FormItem prop="phone">
            <Input type="text" size="large" placeholder="请输入手机号" v-model="formValidate.phone" clearable
               class="bind-input" />
         </FormItem>
         ...
         <FormItem prop="code">
            ...
            <Button v-else type="primary" class="captcha-img" @click="getPhoneCode"
               :disabled="!formValidate.phone">获取短信验证码</Button>
         </FormItem>
         <FormItem>
   ...
   export default {
      ...
      methods: {
         ...
         getPhoneCode() {
            ...
            getPhoneCode(this.formValidate.phone, this.formValidate.userId).then(res => {
               console.log(res);
            });
         },
         showPage() {
