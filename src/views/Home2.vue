  ...
  <div class="wrap-box">
        ...
        <div class="header-contant">
          ...
          <div class="right-contant">
            <div class="contant-item">
              ...
              <div class="number">{{teamList.length}}</div>
            </div>
            <div class="contant-item">
    ...
    <div class="page-wrapper">
      <Row :gutter="24">
        <Col span="16">
          ...
          <Card style="width:100%;margin:1.5em 0">
            ...
            <List class="dynamic-contant">
              ...
              <div class="noList" v-if="dynamicList.length == 0 ">
                <img src="../assets/images/noproject-new.png" />
                <p>暂无数据</p>
              </div>
            </List>
        ...
        <Col span="8">
          <Card style="width:100%; ">
            <p slot="title">我的任务 · {{tasktotal}}</p>

            <Select
              slot="extra"
              v-model="classify"
              class="selectBox"
              style="width:93px; margin-top:-5px;"
            ...
            <div class="task-contant-waper">
              <Tabs value="1" @on-click="changeType">
                ...
                >
                  ...
                  <div class="task-page" v-if="taskList.length">
...
export default {
  ...
  data() {
    return {
      ...
      dynamicList: [], //动态
      tabList: [
        { label: "我执行的", icon: "ios-apps-outline ", name: "1" },
        { label: "我参于的", icon: "ios-contacts-outline", name: "3" },
        { label: "我创建的", icon: "md-clipboard", name: "2" }
      ]
    };
  },
  computed: {
