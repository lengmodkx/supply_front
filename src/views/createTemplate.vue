<template>
  <div>
    <Modal v-model="modal11" fullscreen footer-hide>
      <div
        slot="header"
        class="modal-header header60 header-box-shadow"
        v-if="!ordinary"
      >
        <h3>创建企业模板</h3>
      </div>
      <div slot="header" class="modal-header" v-else>
        ...
        <div class="nav-header df ac">
          <div class="app-tab" @click="clickNavItem(index)" :class="{'active':checkCommentIndex==index}" v-for="(item,index) in navList">
        ...
        <div class="class-content df jsb">
          <div class="class-item" @click="commonTemplate">
            <div class="img-content">
              <img
                src="https://g.alicdn.com/teambition/web/teambition/images/template-simple.2d7759aa.png"
              />
            </div>
          ...
          <div class="class-item">
            <div class="img-content">
              <img
                src="https://g.alicdn.com/teambition/web/teambition/images/template-taskflow.d60d2f5a.png"
              />
            </div>
            <div class="text-content">
          ...
          <div class="class-item">
            <div class="img-content">
              <img
                src="https://g.alicdn.com/teambition/web/teambition/images/template-copy.f2b3d768.png"
              />
            </div>
            <div class="text-content">
      ...
      <div class="modal-content2 task" v-else>
                ...
                <div class="column" :key="k" v-for="(i, k) in allTask">
                    <div
                    style="max-height: calc(100vh - 145px); position: relative"
                    :data-index="k"
                    >
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="check">
                                ...
                                <Checkbox
                                    size="small"
                                    v-model="a.taskStatus"
                                ></Checkbox>
                                </div>
                                <div class="cont">{{ a.taskName }}</div>
                                <Tooltip
                                :content="a.executorName"
                                placement="top"
                                transfer
                                >
                                <img
                            ...
                            <div class="task-info-wrapper">
                                ...
                                >
                                    ...
                                    <span
                                    class="sonTask"
                                    style="line-height: 10px; padding-left: 5px"
                                    >{{ a.completeCount }}/{{ a.childCount }}</span
                                    >
                                </span>
                                <span
                                    class="label"
                                ...
                                >
                                    <div
                                    class="tag-list"
                                    v-for="tag in a.tagList"
                                    :key="tag.tagId"
                                    >
                                    <i :style="{ backgroundColor: tag.bgColor }"></i
                                ...
                                <div
                                class="show-sub-task"
                                @click.stop="showSubTask(a.taskId, a)"
                                v-if="a.childCount > 0"
                                >
                                <Icon
                                    type="ios-arrow-down"
                            ...
                            <div
                            class="liinner"
                            v-for="(task, b) in a.taskList"
                            v-if="a.visible"
                            :key="task.taskId"
                            :data-id="task.taskId"
                            @click.stop="initTask(task.taskId)"
                            >
                            <div
                                class="task-mod"
                                :class="renderTaskStatu(task.priority)"
                            >
                                <div
                                class="teskCheck"
                                @click.stop="changeSubStatus(task)"
                                ></div>
                                <div class="check">
                                <div @click.stop class="checkbox-wrap">
                                    <Checkbox
                                ...
                                <Tooltip
                                    :content="task.executorName"
                                    placement="top"
                                    transfer
                                >
                                    <img
                                    :src="task.executorImg"
                                    class="ava"
                                    v-if="task.executorImg"
                                    alt=""
                                    />
                                </Tooltip>
                                </div>
                        ...
                        <draggable
                        :list="i.taskList"
                        :options="{ group: 'checkedTask', delay: 10 }"
                        class="ul"
                        @end="dragList"
                        >
                        <div
    ...
    <Modal
      ...
      width="570"
      title="模板基本信息"
      class-name="modal-second"
    >
      <div
        slot="header"
        style="text-align: center; font-size: 16px; color: #262626"
        class="header60"
      >
        <span>模板基本信息</span>
      </div>
      <div>
        <div class="div1-box">
          ...
          <div class="df">
            <div class="cover">
              <img
                src="https://art1001-bim-5d.oss-cn-beijing.aliyuncs.com/upload/project/bj.png"
                alt
                v-if="pic_show"
              />
...
import TaskMenu from "../components/project/pages/index/components/TaskMenu.vue";
...
export default {
  ...
  data() {
    return {
      ...
      ordinary: false,
      allTask: [
        { relationName: "待处理", taskList: [] },
        { relationName: "进行中", taskList: [] },
        { relationName: "已完成", taskList: [] },
      ],
      currentEditId: "",
      taskMenuId: null,
      shwoCreate: false,
...
@import "../components/project/pages/index/index.less";
a {
  color: #595959;
  cursor: pointer;
}
