<template>
    <div class="layout">
        <div class='layout-left' >
            <Menu :class=" isCollapsed?'big':'small'" :active-name="menuActive" :open-names="['1']" :theme="'dark'"
                v-if="isCollapsed" @on-select="openTag">
            ...
            <Menu @on-select="openTag" width="81px" v-else class="small-Menu">
                <div>
                    <Dropdown v-for="(item,index) in MenuList" :key="index" placement="right-start"
                        class="menu-dropdown"  @on-click="openTag">
            ...
            <Tabs :value="tabValue" @on-click="tabChange">
                <TabPane :label="item.label" :name="item.value" v-for="(item,index) in projectList" :key="index">
                    ...
                    <div v-if="moShi=='liebiao'">
                        <Row class="ant-list-item" type="flex" align="middle" v-for="(item, index) in projects"
                            :key="index">
                            <Col span="12" class="info-title">
                            <img :src="`https://art1001-bim-5d.oss-cn-beijing.aliyuncs.com/${item.projectCover}`"
                                alt="">
                            <div>
                                <div class="contant">
                            ...
                            <div @click="path(item)" class="col"
                                ...
                                <div class="zzc">
                                    ...
                                    <div class="iconPic" v-if="projectType != '回收站'">
                                        <Tooltip class="iconpic2" :class="{ showStar: item.collect }" content="星标"
                                            placement="top">
        ...
        <Modal v-model="showInviteMembers" width="360" footer-hide>
            ...
            <div class="titleContent">
                ...
                <div class="linkInv" @click='showLink=true;showInviteMembers=false'>通过链接邀请</div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            tabChange(name) {
                ...
                this.orgProjectInit({ id: localStorage.companyId, type: arr[name] }).then(val => {
                    this.searchLoading = false;
                });
...
<style scoped lang="less">
    ...
    .layout-right {
        ...
        .col {
            ...
            height: 128px;
            border-radius: 4px;
            box-shadow: 0 0 0 rgba(56, 56, 56, .6);
