<template>
  <div>
    <div class="join-member">
      ...
      <div class="member-avatar fl" v-for="(item, index) in joinMembers" :key="index" :id="item.userId">
          ...
          <div class="selectable">
            <ul>
              ...
              <li class="select-option-group">
                ...
                <ul>
                  <li class="member-menu-item clearfix" v-for="(item, index) in memberList" :key="item.userId" v-if="ids.indexOf(item.userId) < 0" @click="checkUser(index)">
                    <div class="img fl">
