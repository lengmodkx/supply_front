                ...
                <div class="me-msg" v-if="item.isOwn && item.chatDel == 0">
                  ...
                  <div class="file-box" v-if="item.fileList.length">
                    <div class="one-file" v-for="(f, i) in item.fileList" :key="i">
                      <img v-if="images.indexOf(f.ext) > -1"
                  ...
                  <div class="time me-time">
                    ...
                    <span class="chehui-btn" @click="chehui(item.chatId)"
                      v-if="currentTime - item.createTime < 1000 * 60 * 2">撤回</span>
                  </div>
                </div>
        ...
        <div class="talk">
          <div class="talkinner">
            <div class="talkUp">
              ...
              <div id="input" style="width: 100%;height: 40px;padding: 5px 10px" ref="textarea" placeholder="按Enter快速发布"
                contenteditable="true" @keyup.enter="sendChat" @keyup="SymbolBox($event)"></div>
              <ul class="updata-box">
