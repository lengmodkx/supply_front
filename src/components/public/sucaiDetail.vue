      ...
      <div class="f-header-right">
         ...
         <Dropdown trigger="click" class="upload-file" @on-click="showFileChoose($event)">
          ...
          <DropdownMenu slot="list">
            <DropdownItem name="model" v-if="file.isModel == '1'">上传模型文件</DropdownItem>
            <DropdownItem name="commonfile" v-else-if="file.isModel == '0'">上传普通文件</DropdownItem>
          </DropdownMenu>
        </Dropdown>
         <!-- 下载 -->
         <p class="padd8">
